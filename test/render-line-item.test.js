...
test('renders a line item', assert => {
    ...
    const expected = '<tr><td class="text-align-left">Nimbus 2000</td><td class="text-align-right">2</td><td class="text-align-right">$5,000.00</td><td class="text-align-right">$10,000.00</td></tr>';
